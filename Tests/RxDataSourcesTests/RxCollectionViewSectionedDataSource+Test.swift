...
extension RxCollectionViewSectionedDataSourceTest {
    func testCollectionViewSectionedAnimatedDataSource_optionalConfigureSupplementaryView() {
        let dataSource = RxCollectionViewSectionedAnimatedDataSource<AnimatableSectionModel<String, String>>(configureCell: { _, _, _, _  in UICollectionViewCell() })
